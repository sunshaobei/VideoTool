...
public class ActivityLoginBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_input_name, 1);
        sViewsWithIds.put(R.id.text_input_password, 2);
        sViewsWithIds.put(R.id.checkbox_, 3);
    ...
    @NonNull
    private final com.sunsh.baselibrary.widgets.overscroll.OverScrollLayout mboundView0;
    @NonNull
    public final com.sunsh.baselibrary.widgets.SearchEditText textInputName;
    @NonNull
    public final com.sunsh.baselibrary.widgets.SearchEditText textInputPassword;
    @NonNull
    public final android.widget.TextView tvAgreement;
    // variables
    // values
    // listeners
    ...
    public ActivityLoginBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.mboundView0 = (com.sunsh.baselibrary.widgets.overscroll.OverScrollLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.textInputName = (com.sunsh.baselibrary.widgets.SearchEditText) bindings[1];
        this.textInputPassword = (com.sunsh.baselibrary.widgets.SearchEditText) bindings[2];
        this.tvAgreement = (android.widget.TextView) bindings[4];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityLoginBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityLoginBinding>inflate(inflater, com.ccee.videotool.R.layout.activity_login, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityLoginBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.ccee.videotool.R.layout.activity_login, null, false), bindingComponent);
    }
    @NonNull
