...
public class SnapRecorderSetting extends Activity implements View.OnClickListener {
    ...
    public static void startRecordForResult(Activity var0, int var1) {
        Intent var3 = new Intent(var0, AliyunVideoRecorder.class);
        ...
        var3.putExtra("max_duration", 15000);
        var3.putExtra("min_duration", 3000);
...
//        var3.putExtra("video_framerate", 5);
        ...
        var3.putExtra("min_crop_duration", 3000);
        var3.putExtra("min_video_duration", 3000);
        var3.putExtra("max_video_duration", 15000);
        var0.startActivityForResult(var3, var1);
        var0.overridePendingTransition(R.anim.slid_up_enter,R.anim.slid_down_exit);
    }
